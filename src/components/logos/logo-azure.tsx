...
const LogoAzure = ({ title, titleId, ...props }: Props) => (
  <svg
    width={24}
    height={24}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path
      ...
      fill="url(#paint0_linear_11075_34671)"
    />
    <path
    ...
    <path
      ...
      fill="url(#paint1_linear_11075_34671)"
    />
    <path
      ...
      fill="url(#paint2_linear_11075_34671)"
    />
    <defs>
      <linearGradient
        id="paint0_linear_11075_34671"
        x1={15.8531}
        y1={4.28024}
        x2={12.073}
        y2={22.0253}
