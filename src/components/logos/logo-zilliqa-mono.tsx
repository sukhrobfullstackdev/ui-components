...
const LogoZilliqaMono = ({ color: customColor, title, titleId, ...props }: Props) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
      />
      <path d="M5.25 3.50207L16.2195 8.761L19.0279 7.50887L8.10306 2.24994L5.25 3.50207Z" fill="#DDDBE0" />
      <path d="M16.22 8.74911L19.0284 7.49698V10.2964L16.22 11.5485V8.74911Z" fill="#B6B4BA" />
      <path
        ...
        fill="currentColor"
      />
      <path d="M16.22 21.729L19.0284 20.4769V11.7299L16.22 12.9954V21.729Z" fill="#B6B4BA" />
    </svg>
  );
};
export default LogoZilliqaMono;
