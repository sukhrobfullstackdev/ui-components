...
const IcoInfoCircle = ({ color: customColor, title, titleId, ...props }: Props) => {
  ...
  return (
    ...
    >
      ...
      <path
        d="M10.7446 7C10.7446 6.30964 11.3043 5.75 11.9946 5.75H12.0036C12.694 5.75 13.2536 6.30964 13.2536 7C13.2536 7.69036 12.694 8.25 12.0036 8.25H11.9946C11.3043 8.25 10.7446 7.69036 10.7446 7Z"
        fill="currentColor"
      />
      <path
